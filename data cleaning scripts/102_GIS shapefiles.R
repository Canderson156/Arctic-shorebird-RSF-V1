...
#Dataframe for matching GIS plot names with Historic Plot names if the shapefile doesn't have the standardized version
...
#See MatchingPlotID_Larent for deails about why each was performed
...
shapefile_proj_list[[22]]@data$Plot_GOOD[is.na(shapefile_proj_list[[22]]@data$Plot_GOOD)] <- shapefile_proj_list[[22]]@data$FN[is.na(shapefile_proj_list[[22]]@data$Plot_GOOD)]
...
shapefile_proj_list[[25]]@data$Plot_GOOD[is.na(shapefile_proj_list[[25]]@data$Plot_GOOD)] <- shapefile_proj_list[[25]]@data$FN[is.na(shapefile_proj_list[[25]]@data$Plot_GOOD)]
...
shapefile_proj_list[[34]]@data <- merge(shapefile_proj_list[[34]]@data, historic_plot_names[historic_plot_names$Region_code == 10,], by = "FN", all.x = TRUE, sort = FALSE)  
